...
public class QRcode {
    ...
    private static final Map<EncodeHintType, Object> hints = new HashMap(){//二维码参数
        {
            put(EncodeHintType.CHARACTER_SET, "utf-8");//字符编码
            put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);//容错等级 H为最高
            put(EncodeHintType.MARGIN, 2);//边距
        }
    };

    public static void main(String[] args) throws Exception{
//        for (int a=0;a<20;a++){
//            File file = new File("D:\\二维码\\img"+a+".jpg");
//            OutputStream outputStream = new FileOutputStream(file);
//            QRcode.writeToStream("http://192.168.0.110:8888/?uuid=6916116810c9795736ae79e424dc11f0&password=111111",outputStream);
//        }
